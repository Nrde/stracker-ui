...
% end
    ...
    <style>
        ...
        table#lapstable tr.even:hover td, table#lapstable tr.odd:hover td {
            background-color: #d7f6e7 !important;
        }
...
% # comment lines below in case you want page paginator to be visible
% del pagination
% pagination = (None)
